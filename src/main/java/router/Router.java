...
public class Router<T>
{
    ...
    public RouteResult<T> route(final HttpMethod method, final String uri)
    {
        ...
        final String[] tokens = Path.removeSlashesAtBothEnds(decoder.path()).split("/");
        ...
        if (notFound != null)
        {
            ...
            return new RouteResult<>(notFound, new HashMap<>(), decoder.parameters());
        }
    ...
    public Set<HttpMethod> allowedMethods(final String uri)
    {
        ...
        final Set<HttpMethod> ret = new HashSet<>(routers.size());
    ...
    public Set<HttpMethod> allAllowedMethods()
    {
        ...
        {
            final Set<HttpMethod> ret = new HashSet<>(9);
    ...
    public String toString()
    {
        ...
        final List<String> methods = new ArrayList<>(numRoutes);
        final List<String> paths = new ArrayList<>(numRoutes);
        final List<String> targets = new ArrayList<>(numRoutes);
